...
Реализован 2 этап, программа может прочитать зависимости пакета Rust (crate). Если репоизторий находится на локально диске, то программа прочитает зависимости из Cargo.toml, если указаны только название и версия пакета, то программа выполнит поиск зависимостей пакета с помощью crate.io api.
